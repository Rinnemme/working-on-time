  ...
  return (
    <div className="flex gap-3 items-center">
      <input
        ...
        max="1"
        className={
          "w-full h-4 bg-wot-light-gray rounded-lg appearance-none hover:cursor-pointer bg-transparent [&::-webkit-slider-runnable-track]:rounded-full [&::-webkit-slider-runnable-track]:bg-wot-light-gray [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:rounded-full  " +
          (working
            ? "[&::-webkit-slider-thumb]:bg-wot-rose"
            : "[&::-webkit-slider-thumb]:bg-wot-blue")
        }
      ></input>
