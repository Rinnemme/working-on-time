...
export default function WorkingSession({ project }: { project: Project }) {
  ...
  return (
    <div className="bg-wot-off-white top-0 w-full h-full z-0 fade-in">
      {isLoading && <Throbber />}
      <div className="relative flex flex-col items-center pt-12 mb-20 sm:pt-14 justify-center w-full bg-white">
        ...
        <div className="max-w-2xl w-full flex justify-center items-end gap-4 mt-10 flex-wrap-reverse">
          <div className="w-[300px] h-fit p-4 border-wot-light-gray border overflow-y-auto">
